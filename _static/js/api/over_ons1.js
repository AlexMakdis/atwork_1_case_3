(() => {
  const app = {
    ...
    async loadProjects () {
      ...
      Ajax.fetchJsonByHandlers(`${location.origin}/_static/json/over_ons1.json`,
        (data) => {
          // console.log(data);
    ...
    generateUIForProjects () {
      if (this.projectsData !== null && this.projectsListElement !== null) {
        ...
        this.projectsData.forEach((project, index) => {
          ...
          <div class="g-fb-col-12 g-fb-col-md-6 over_ons_dienst over_ons_dienst1" data-id="${index}">
