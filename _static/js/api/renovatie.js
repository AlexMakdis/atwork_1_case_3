(() => {
  const app = {
    ...
    async loadProjects () {
      ...
      Ajax.fetchJsonByHandlers(`https://establis.herokuapp.com/api/projects?field_project_type_target_id=16`,
        (data) => {
          // console.log(data);
    ...
    generateUIForProjects () {
      if (this.projectsData !== null && this.projectsListElement !== null) {
        ...
        this.projectsData.forEach((project, index) => {
          ...
          projectElement.classList.add('g-fb-col-8', 'project','project_2');
          projectElement.innerHTML = `
          <div class="kaas" data-id="${index}"><a href="../detail/index.html">
